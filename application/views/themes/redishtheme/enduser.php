                ...
                <div class="profileTabList row">
                    ...
                    <div class="tab-content col-md-9 col-lg-10" id="nav-tabContent">
                        <?php if(isset($alert) || $alert = $this->session->flashdata('alert')) { ?>
                            <div class="<?php echo html_escape($alert['type']) ?> alert-dismissible fade show rounded">
                                ...
                                <div class="row">
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <input value="<?php echo html_escape($user['fullName']) ?>" type="text" class="form-control formControlInput" name="fullname" placeholder="Your Full Name">
                                            <?php echo form_error('fullname', '<small class="text-danger">', '</small>') ?>
                                        </div>
                                        <div class="form-group m-b-0">
                                            <label for="exampleInputEmail1"><b>Email</b></label>
                                            <input disabled type="email" value="<?php echo html_escape($user['email']) ?>" class="form-control formControlInput" placeholder="Enter email">
