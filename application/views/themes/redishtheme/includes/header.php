...
<header class="headerMain">
	<div class="headerMainInner <?php echo_if($uri == 'enduser' || $uri == 'userbooking', 'headerMainSticky fadeInDown animated'); ?>">
		<nav class="navbar">
			<div class="container">
				<a href="<?php echo base_url()?>" class="brandLogo"><img class="lammy_brand_logo" src="<?php $assets('images/lammy_logo.jpeg'); ?>" alt=""></a>
				<a href="<?php echo base_url()?>" class="stickyLogo"><img class="lammy_sticky_logo" src="<?php $assets('images/lammy_logo.jpeg'); ?>" alt=""></a>
					...
					<div class="mainMenu">
						<ul id="myDIV">
							...
							<?php foreach($pages as $page) { if($page['status'] && ($page['position'] == 1 || $page['position'] == 3)) { ?>
								<li class="bdtn"><a href="<?php anchor_to('page/' . $page['permalink']) ?>"><?php echo html_escape($page['title'], true) ?></a></li>
							<?php } } ?>
