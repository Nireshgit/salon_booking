...
<?php $theme_view('includes/header'); ?>
		...
		<div class="container">
			<div class="row">
				<div class="col-lg-7">
					...
					?>
						<div class="alert <?php echo html_escape($added_class, true);?>"><?php echo html_escape($added, true);?></div>
					<?php
					}
					?>
							...
							<div class="singleInput form-group">
								<select class="custom-select selectBookNow" id="selectBookNow" name="serviceTitle" required>
									...
									<?php foreach ($serviceList as $servList ){ ?>
										<option value="<?php echo html_escape($servList['id'], true)?>" label="<?php echo html_escape($servList['title'], true)?>"><?php echo html_escape($servList['title'], true)?></option>
									<?php }?>
								</select>
				...
				<?php foreach ($serviceList as $servList ){ ?>
					...
					<div class="col-lg-4 col-md-6 mx-auto text-center">
						<div class="servicesBox">
							...
							<h4><?php echo html_escape($servList['title'], true)?></h4>
							<div class="serviceInfoMain">
								<div class="media mb-3">
									<i class="icon-clock serviceInfoicon"></i>
									<div class="media-body">
										<p class="serviceInfoHeading">Duration:</p>
										<p class="serviceInfoValue"><?php echo html_escape($servList['servDuration'], true)?></p>
									</div>
								</div>
								<div class="media mb-3">
									...
									<div class="media-body">
										...
										<p class="serviceInfoValue">$<?php echo html_escape($servList['price'], true)?></p>
									</div>
								</div>
								<div class="media">
									...
									<div class="media-body">
										...
										<p class="serviceInfoValue"><?php echo html_escape($servList['servSpace'], true)?></p>
									</div>
								</div>
								<a href="#home" class="booknowBtn btn btn-dark" data-value="<?php echo html_escape($servList['id'], true)?>">Book Now</a>
							</div>
	...
	<div class="gallerySection" id="gallery">
		<div class="container">
				...
				<div class="col-12">
					<ul class="filterList">
						...
						<?php foreach ($gcategories as $gcat ){ if($gcat['count'] != 0){?>
							<li data-filter=".cg<?php echo html_escape($gcat['id'], true) ?>"><?php echo html_escape($gcat['cName'], true) ?></li>
						<?php }} ?>
					</ul>
				</div><!-- /.col-12 -->
			</div><!-- /.row -->
			<div class="row grid galleryLists">
				...
				<div class="col-lg-3 col-md-6 grid-item cg<?php echo html_escape($gImage['catId'], true) ?>">
					<a class="d-block portfolioBox wow fade-in-bottom" href="<?php uploads('gallery/'.$gImage['imgPath']);?>" style="background-image: url(<?php uploads('gallery/'.$gImage['imgPath']);?>)">
						...
						<div class="portfolioBoxInnerContent">
							<h6><?php echo html_escape($gImage['imgName'], true) ?></h6>
							<p>
								<span><?php echo html_escape($gImage['imgDetails'], true); ?></span>
							</p>
				...
				<div class="col-lg-7">
					...
					<form id="mailmesubmit" action="<?php echo base_url(HOMEPAGE_CONTROLLER.'/mailme') ?>" class="rt-form rt-line-form">
						...
						<div class="form-group text-left">
							<div class="g-recaptcha" data-sitekey="<?php echo html_escape($recaptcha['site_key']) ?>"></div>
						</div>
						<?php } ?>
	...
	<div class="contactMapArea">
				...
				<div class="row">
					<div class="col-lg-4 mx-auto col-md-6">
						<div class="contactThreeColumns">
							...
							<div class="iconboxContent">
								<h5>Our Address</h5>
								<p><?php echo html_escape($contactdetails['address'], true) ?></p>
							</div><!-- /.iconboxContent -->
					...
					<div class="col-lg-4 mx-auto col-md-6">
						<div class="contactThreeColumns" data-wow-duration="1.5s">
							...
							<div class="iconboxContent">
								<h5>Phone & Email</h5>
								<p><?php echo html_escape($contactdetails['phone'], true) ?> <br>
								<?php echo html_escape($contactdetails['email'], true)?></p>
							</div><!-- /.iconboxContent -->
						</div><!-- /.rt-single-icon-box -->
					</div><!-- /.col-lg-4 -->
					<div class="col-lg-4 mx-auto col-md-6">
						<div class="contactThreeColumns" data-wow-duration="2s">
							...
							<div class="iconboxContent">
								...
								<ul class="contactSocial">
									<li><a href="<?php echo html_escape($contactdetails['urlFb'], true) ?>"><i class="icon-facebook"></i></a></li>
									<li><a href="<?php echo html_escape($contactdetails['urlTwt'], true) ?>"><i class="icon-twitter"></i></a></li>
									<li><a href="<?php echo html_escape($contactdetails['urlIn'], true) ?>"><i class="icon-linkedin2"></i></a></li>
								</ul>
							</div><!-- /.iconboxContent -->
						</div><!-- /.rt-single-icon-box -->
					</div><!-- /.col-lg-4 -->
			...
			<div class="googleMap">
				<iframe src="<?php echo html_escape($contactdetails['map_src'], true) ?>" width="<?php echo html_escape($contactdetails['map_wd'], true) ?>" height="<?php echo html_escape($contactdetails['map_ht'], true) ?>" frameborder="0" style="border:0;" allowfullscreen="" aria-hidden="false" tabindex="0"></iframe>
			</div>
	</div>
	<!-- /contactMapArea -->	
