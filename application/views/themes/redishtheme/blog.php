                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="card card-product blogCard" data-count="4">
                                ...
                                <div class="card-body">
                                    <h4 class="card-title">
                                        <a href="<?php anchor_to(BLOG_CONTROLLER.'/'.$blist['permalink']) ?>"><?php echo word_limiter(html_escape($blist['title'], true), 8) ?></a>
                                    </h4>
                                    <div class="card-description"><?php echo word_limiter(html_escape($blist['description'], true), 17) ?></div>
                                </div>
                                <div class="card-footer">
                                    <div class="left">
                                        <p class="cardDate">
                                            <i class="icon-calendar"></i> <?php
                                                    if($blist['datetime_updated'] != $blist['datetime_added']){echo html_escape($blist['datetime_updated'], true);}else{echo html_escape($blist['datetime_added'], true);}
                                                ?>
                                        </p>
	                                </div>
                                    <div class="left">
