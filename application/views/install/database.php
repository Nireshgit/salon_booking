		...
		<div class="tabs-area">
			...
			<div class="tabs-content">
				...
				<div class="text-fld-div">
					<input type="text" name="host" placeholder="e.g: localhost" value="<?php echo html_escape(isset($host) ? $host : ""); ?>" class="form-control text-fld" required/>
					<?php echo form_error('host', '<div class="m-t-5 text-danger"><small>', '</small></div>'); ?>
				</div>
				<label class="label-tabs">Database Name</label>
				<div class="text-fld-div">
					<input type="text" name="database" placeholder="Database Name" value="<?php echo html_escape(isset($database) ? $database : ""); ?>" class="form-control text-fld" required/>
					<?php echo form_error('database', '<div class="m-t-5 text-danger"><small>', '</small></div>'); ?>
				</div>
				<label class="label-tabs">Database Username</label>
				<div class="text-fld-div">
					<input type="text" name="username" placeholder="Database Username" value="<?php echo html_escape(isset($username) ? $username : ""); ?>" class="form-control text-fld" required/>
					<?php echo form_error('username', '<div class="m-t-5 text-danger"><small>', '</small></div>'); ?>
				</div>
				<label class="label-tabs">Database Password</label>
				<div class="text-fld-div">
					<input type="password" name="password" placeholder="Database Password" value="<?php echo html_escape(isset($password) ? $password : ""); ?>" class="form-control text-fld"/>
				</div>
