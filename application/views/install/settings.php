		...
		<div class="tabs-area">
			...
			<div class="tabs-content">
				...
				<div class="text-fld-div">
					<input type="url" name="install_path" onkeypress="return AvoidSpace(event)" value="<?php echo html_escape(isset($install_path) ? $install_path : ""); ?>" placeholder="Enter Installation Path" class="form-control text-fld" required>
				...
				<div class="text-fld-div">
					<input type="text" name="website_title" maxlength="70" value="<?php echo html_escape(isset($website_title) ? $website_title : ""); ?>" placeholder="Enter Website Title" class="form-control text-fld" required>
					<?php echo form_error('website_title', '<div class="m-t-5 text-danger"><small>', '</small></div>'); ?>
				</div>
				<label class="label-tabs">Admin Email</label>
				<div class="text-fld-div">
					<input type="email" name="email" onkeypress="return AvoidSpace(event)" value="<?php echo html_escape(isset($email) ? $email : ""); ?>" placeholder="Enter Admin Email" class="form-control text-fld" required>
				...
				<div class="text-fld-div">
					<input type="text" name="username" onkeypress="return AvoidSpace(event)" value="<?php echo html_escape(isset($username) ? $username : ""); ?>" placeholder="Enter Admin Username" class="form-control text-fld" required>
				...
				<div class="text-fld-div">
					<input type="password" name="password" minlength="5" onkeypress="return AvoidSpace(event)" value="<?php echo html_escape(isset($password) ? $password : ""); ?>" placeholder="Enter Admin Password" class="form-control text-fld" required>
