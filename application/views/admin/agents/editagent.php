                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="text" id="agentName" name="agentName" placeholder="Agent Name" value="<?php echo html_escape(set_value('agentName', $agent['agentName']), true)?>">
                                </div>
                                <div class="form-group">
                                    ...
                                    <textarea id="service-content" name="agentDescription" class="form-control"><?php echo html_escape(set_value('agentDescription', $agent['agentDetail']), true)?></textarea>
                                </div>
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input min="1" step="1" class="form-control" type="number" id="service-price" name="experience" placeholder="Experience" value="<?php echo html_escape(set_value('experience', $agent['experience']), true)?>">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input min="1" step="1" class="form-control" type="number" id="totalBookings" name="totalBookings" placeholder="Total Bookings" value="<?php echo html_escape(set_value('totalBookings', $agent['totalBookings']), true)?>">
                                                </div>
                                            </div>
