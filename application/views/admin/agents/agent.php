                            ...
                            <div class="table-responsive">
                                <table class="table table-striped mt-3">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td><?php echo html_escape($agent['id'], true) ?></td>
                                            <td><img src="<?php uploads('img/agents/'.html_escape($agent['agentImage'], true)) ?>" class="img-thumbnail mr-2 rounded-circle" width="45px"><?php echo html_escape($agent['agentName'], true) ?></td>
                                            <td><div class="agentDetails"><?php echo html_escape($agent['agentDetail'], true) ?></div></td>
                                            <td><?php echo html_escape($agent['experience'], true) ?> Years</td>
                                            <td><?php echo html_escape($agent['totalBookings'], true) ?></td>
                                            <td>
                                                ...
                                                <button type="button" class="btn btn-link btn-danger deleteAgent" data-toggle="tooltip" data-placement="top" title="Delete" value="<?php echo html_escape($agent['id'], true) ?>"><i class="fa fa-times"></i></button>
                                            </td>
                                        </tr>
                                        <?php } }?>
                                    </tbody>
