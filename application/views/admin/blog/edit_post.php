						...
						<div class="row">
							<div class="col-12">
								<div class="form-group">
									...
									<input class="form-control" type="text" id="title" name="title" placeholder="Choose Image Title" value="<?php echo html_escape(set_value('title', $postData['title']), true)?>">
								</div>
								<div class="form-group">
									<label for="description">Description <span class="text-danger">*</span></label>
									<?php echo form_error('description', '<br><span class="text-danger">', '</span>'); ?>
									<textarea id="service-content" name="description" class="form-control" placeholder="Choose Image Short Description"><?php echo html_escape(set_value('description', $postData['description']), true)?></textarea>
								</div>
								<div class="form-group">
