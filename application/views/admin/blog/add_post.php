				  ...
				  <form action="<?php anchor_to(ADMINBLOG_CONTROLLER . '/add_post') ?>" method="POST" enctype="multipart/form-data">
					<div class="card-body">
						<div class="row">
                           ...
                           <input class="form-control" type="text" id="title" name="title" placeholder="Choose Image Title" value="<?php echo html_escape(set_value('title'), true)?>">
                        </div>
                        <div class="form-group">
                           <label for="description">Description <span class="text-danger">*</span></label>
                           <?php echo form_error('description', '<br><span class="text-danger">', '</span>'); ?>
                           <textarea id="service-content" name="description" class="form-control" placeholder="Choose Image Short Description"><?php echo html_escape(set_value('description'), true)?></textarea>
                        </div>
