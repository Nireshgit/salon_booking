                            ...
                            <div class="table-responsive">
                                <table class="table table-striped mt-3">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td><?php echo html_escape($blogList['id'], true) ?></td>
                                            <td><?php echo word_limiter(html_escape($blogList['title'], true), 8) ?></td>
                                            <td><?php echo word_limiter(html_escape($blogList['description'], true), 15) ?></td>
                                            <td><?php echo html_escape($blogList['datetime_added'], true) ?></td>
                                            <td>
                                                <?php 
                                            ...
                                            <td class="d-flex justify-content-center align-items-center">
                                                ...
                                                <button type="button" class="btn btn-link btn-danger delete_post" value="<?php echo html_escape($blogList['id'], true) ?>" data-toggle="tooltip" data-placement="top" title="Delete"><i class="fa fa-times"></i></button>
                                            </td>
                                        </tr>
                                        <?php } }?>
                                    </tbody>
