                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="text" id="service-title" name="service-title" placeholder="Choose Service Title" value="<?php echo html_escape(set_value('service-title', $service['title']), true)?>">
                                </div>
                                <div class="form-group">
                                    ...
                                    <textarea id="service-content" name="service-content" class="form-control"><?php echo html_escape(set_value('service-content', $service['description']), true)?></textarea>
                                </div>
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="row">
                                            <div class="col-12">
                                                <div class="form-group">
                                                    ...
                                                    <input data-decimals="2" min="1" step="0.1" class="form-control" type="number" id="service-price" name="service-price" placeholder="Choose Service Price" value="<?php echo html_escape(set_value('service-price', $service['price']), true)?>">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input min="1" step="1" class="form-control" type="number" id="service-space" name="service-space" placeholder="Choose Service Space" value="<?php echo html_escape(set_value('service-space', $service['servSpace']), true)?>">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input class="form-control" id="servEnds" type="text" name="service-ends" placeholder="Type: 05:00 PM" value="<?php echo html_escape(set_value('service-ends', $service['servEnd']), true)?>">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input class="form-control" type="text" id="service-duration" name="service-duration" placeholder="Service Duration: 02:30" value="<?php echo html_escape(set_value('service-duration', $service['servDuration']), true)?>">
                                                </div>
                                            </div>
											<div class="col-12">
                                                <div class="form-group">
                                                    ...
                                                    <select id="multiple" name="agent[]" class="form-control" multiple="multiple">
														<optgroup label="Select Agent">
															<?php foreach($agents as $agent){ ?>
                                                                <option <?php if(in_array($agent['id'], $service['agentIds'])) { ?>selected<?php } ?> value="<?php echo html_escape($agent['id'], true)?>"><?php echo html_escape($agent['agentName'], true)?></option>
                                                            <?php } ?>
														</optgroup>
                                                    </select>
                                                </div>
