                            ...
                            <div class="table-responsive">
                                <table class="table table-striped mt-3">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td><?php echo html_escape($serv['id'], true) ?></td>
                                            <td><?php echo html_escape($serv['title'], true) ?></td>
											<td>
											<?php 
												$agents = '';
												...
												$agents = trim($agents, ', ');
												echo html_escape($agents, true);
											?>
											</td>
                                            <td><?php echo html_escape($serv['description'], true) ?></td>
                                            <td><?php echo html_escape($serv['price'], true) ?></td>
                                            <td><?php echo html_escape($serv['servDuration'], true) ?></td>
                                            <td>
                                                ...
                                                <button type="button" class="btn btn-link btn-danger deleteService" data-toggle="tooltip" data-placement="top" title="Delete" value="<?php echo html_escape($serv['id'], true) ?>"><i class="fa fa-times"></i></button>
                                            </td>
                                        </tr>
                                        <?php } }?>
                                    </tbody>
