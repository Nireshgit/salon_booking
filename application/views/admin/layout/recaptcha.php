						...
						<div class="row">
							<div class="col-12">
								<div class="form-group">
									...
									<input type="text" name="site-key" class="form-control resize-none" id="site-key" placeholder="Enter your Recaptcha Site Key." value="<?php echo html_escape($page_data['recaptcha']['site_key']) ?>">
								</div>
                                <div class="form-group">
									<label for="secret-key">Secret Key</label>
                                    <?php echo form_error('secret-key', '<br><span class="text-danger">', '</span>') ?>
									<input type="text" name="secret-key" class="form-control resize-none" id="secret-key" placeholder="Enter your Recaptcha Secret Key." value="<?php echo html_escape($page_data['recaptcha']['secret_key']) ?>">
								</div>
                                <div class="form-group">
