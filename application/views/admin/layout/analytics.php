						...
						<div class="row">
							<div class="col-12">
								<div class="form-group">
									...
									<input name="site-analytics" class="form-control form-control-lg resize-none" id="analytics" value="<?php echo html_escape($page_data['analytics'], true) ?>" placeholder="Ex: UA-123456789-0">
