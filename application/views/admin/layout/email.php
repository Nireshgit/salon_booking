						...
						<div class="row">
							<div class="col-12">
								<div class="form-group">
                                    ...
                                    <input type="email" id="site-smtp-email" name="site-smtp-email" value="<?php echo html_escape($page_data['email']['email']) ?>" class="form-control">
                                ...
                                <div id="smtp-settings-container" class="<?php echo_if(!$page_data['email']['status'], 'd-none') ?>">
                                    <div class="form-group">
                                        ...
                                        <input placeholder="Your SMTP Host" type="text" id="site-smtp-host" name="site-smtp-host" value="<?php echo html_escape($page_data['email']['host']) ?>" class="form-control">
                                    </div>
                                    <div class="form-group">
                                        <label for="site-smtp-port">SMTP Port</label>
                                        <?php echo form_error('site-smtp-port', '<br><span class="text-danger">', '</span>') ?>
                                        <input placeholder="Your SMTP Port" type="number" id="site-smtp-port" name="site-smtp-port" value="<?php echo html_escape($page_data['email']['port']) ?>" class="form-control">
                                    </div>
                                    <div class="form-group">
                                        <label for="site-smtp-username">SMTP Username</label>
                                        <?php echo form_error('site-smtp-username', '<br><span class="text-danger">', '</span>') ?>
                                        <input placeholder="Your SMTP Username" type="text" id="site-smtp-username" name="site-smtp-username" value="<?php echo html_escape($page_data['email']['username']) ?>" class="form-control">
                                    </div>
                                    <div class="form-group">
                                        <label for="site-smtp-password">SMTP Password</label>
                                        <?php echo form_error('site-smtp-password', '<br><span class="text-danger">', '</span>') ?>
                                        <input placeholder="Your SMTP Password" type="text" id="site-smtp-password" name="site-smtp-password" value="<?php echo html_escape($page_data['email']['password']) ?>" class="form-control">
                                    </div>
                                </div>
							</div>
						</div>
