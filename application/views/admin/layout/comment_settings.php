					...
					<div class="card-body">
                        ...
                        <div id="facebook-settings-container" class="settings-container <?php echo($page_data['comment_settings']['active_plugin'] == 1 ? null : "d-none"); ?>">
                           <div class="form-group">
                                 ...
                                 <input placeholder="Facebook APP ID" type="text" id="facebook-app-id" name="facebook-app-id" value="<?php echo html_escape($page_data['comment_settings']['facebook_app_id']) ?>" class="form-control">
                           </div>
                        </div>
                           ...
                           <div class="form-group">
                                 ...
                                 <input placeholder="Disqus Short Name" type="text" id="disqus-short-name" name="disqus-short-name" value="<?php echo html_escape($page_data['comment_settings']['disqus_short_name']) ?>" class="form-control">
                           </div>
                        </div>
							</div>
						</div>
