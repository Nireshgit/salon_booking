                                ...
                                <div class="col-12">
                                    ...
                                    <div id="sortable-list" class="pages-area">
                                        <?php foreach($all_pages as $page) { ?>
                                            <div data-pl="<?php echo html_escape($page['permalink']) ?>" class="page-sortable mt-2 p-3 bg-light text-dark border rounded">
                                                <div class="cst-table-row">
                                                    <div class="row">
                                                        <div class="col-5">
                                                            <span><?php echo html_escape($page['title'], true) ?></span>
                                                        </div>
                                                        <div class="col-3">
                                                            <span><a href="<?php anchor_to(PAGE_CONTROLLER . '/' . $page['permalink']) ?>" target="_blank"><?php echo html_escape($page['permalink']) ?></a></span>
                                                        </div>
                                                        <div class="col-2">
