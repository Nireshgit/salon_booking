         ...
         <div class="page-header">
            ...
            <ul class="breadcrumbs">
               ...
               <li class="nav-home">
                  ...
                  <?php echo html_escape($page_title, true) ?>
                  </a>
               </li>
            </ul>
         </div>
            ...
            <div class="col-md-12">
               <div class="card">
                  <div class="card-header">
                     <div class="card-title">Update <u><?php echo html_escape($page['title'], true) ?></u></div>
                  </div>
				<div class="card-body">
					<div class="row">
						<div class="col-12">
                            <form method="POST" action="<?php anchor_to(LAYOUT_CONTROLLER . '/edit_page/' . $page['permalink']) ?>">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="text" id="page-title" name="page-title" placeholder="Choose Page Title" value="<?php echo html_escape($page['title'], true) ?>">
                                </div>
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="text" id="page-permalink" name="page-permalink" placeholder="Choose Page Permalink" value="<?php echo html_escape($page['permalink']) ?>">
                                </div>
                                <div class="form-group">
                                    ...
                                    <textarea id="service-content" name="page-content" class="form-control"><?php echo html_escape($page['content'], true) ?></textarea>
                                </div>
                                <div class="form-group">
