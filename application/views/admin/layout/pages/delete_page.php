            ...
            <div class="col-md-12">
               <div class="card">
                  <div class="card-header">
                     <div class="card-title">Delete Page <u><?php echo html_escape($page['title'], true) ?></u></div>
                  </div>
				<div class="card-body">
					<div class="row">
						<div class="col-12">
                            <p>Confirm The Deletion of <strong><?php echo html_escape($page['title'], true); ?></strong></p>
