						...
						<div class="row">
							<div class="col-lg-6">
								<div class="form-group">
									...
									<textarea rows="4" name="site-header-scripts" class="form-control form-control-lg resize-none" id="header-scripts" placeholder="Scripts to include inside the <head> tag."><?php echo html_escape($page_data['scripts']['header'], true) ?></textarea>
							...
							<div class="col-lg-6">
                                <div class="form-group">
									...
									<textarea rows="4" name="site-footer-scripts" class="form-control form-control-lg resize-none" id="footer-scripts" placeholder="Scripts to include before the </body> tag."><?php echo html_escape($page_data['scripts']['footer'], true) ?></textarea>
