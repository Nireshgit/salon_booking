						...
						<div class="row">
							<div class="col-12">
								<div class="form-group">
									...
									<textarea rows="4" name="site-meta-tags" class="form-control form-control-lg resize-none" id="meta-tags" placeholder="Enter your Meta Tags right here."><?php echo html_escape($page_data['meta_tags'], true) ?></textarea>
