                                ...
                                <div class="col-md-12">
                                    <form method="POST" action="<?php anchor_to(LAYOUT_CONTROLLER . '/social_keys') ?>">
                                        <div class="form-group">
                                            ...
                                            <input id="google-public" name="google-public" placeholder="Your Google API Client ID" value="<?php echo html_escape($page_data['social_keys']['google_public']) ?>" type="text" class="form-control">
                                        </div>
                                        <div class="form-group">
                                            <label for="google-secret">Google Secret Key</label>
                                            <input id="google-secret" name="google-secret" placeholder="Your Google API Client Secret Key" value="<?php echo html_escape($page_data['social_keys']['google_secret']) ?>" type="text" class="form-control">
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input id="facebook-public" name="facebook-public" placeholder="Your Facebook Developer Public Key" value="<?php echo html_escape($page_data['social_keys']['facebook_public']) ?>" type="text" class="form-control">
                                        </div>
                                        <div class="form-group">
                                            <label for="facebook-secret">Facebook Private Key</label>
                                            <input id="facebook-secret" name="facebook-secret" placeholder="Your Facebook Developer Private Key" value="<?php echo html_escape($page_data['social_keys']['facebook_secret']) ?>" type="text" class="form-control">
                                        </div>
                                        <div class="form-group">
