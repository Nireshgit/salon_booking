                            ...
                            <div class="table-responsive">
                                <table class="table table-striped mt-3">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td><?php echo html_escape($booking['id'], true) ?></td>
                                            ...
                                            <td class="text-right">
                                                <div class="dropdown">
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-right">
                                                        ...
                                                        <?php } ?>
                                                        <button type="button" class="btn btn-link btn-danger dropdown-item deleteBookings" value="<?php echo html_escape($booking['id'], true) ?>">Delete</button>
                                                    </div>
                                                </div>   
                                            </td>
                                        </tr>
