                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="text" id="image-title" name="image-title" value="<?php echo html_escape(set_value('image-title', $gallery['imgName']), true)?>">
                                </div>
                                <div class="form-group">
                                    ...
                                    <textarea id="service-content" name="image-content" class="form-control"><?php echo html_escape(set_value('image-content', $gallery['imgDetails']), true)?></textarea>
                                </div>
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select name="categoryId" id="" class="form-control custom-select">
                                                <?php foreach($categories as $gCat){ ?>
                                                    <option value="<?php echo html_escape($gCat['id'], true)?>"<?php echo ($gCat['id'] == $gallery['catId']) ? 'selected' : '' ?>><?php echo html_escape($gCat['cName'], true)?> - (<?php echo html_escape($gCat['count'], true)?>)</option>
                                                <?php } ?>
                                            </select>
                                        </div>
                                    </div>
