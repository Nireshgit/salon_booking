                            ...
                            <div class="table-responsive">
                                <table class="table table-striped mt-3">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td><?php echo html_escape($gCat['cName'], true) ?></td>
                                            <th class="text-right"><?php echo html_escape($gCat['count'], true) ?></th>
                                            <td class="text-right">
                                                ...
                                                <button type="button" class="btn btn-link btn-danger catDelete" data-toggle="tooltip" data-placement="top" title="Delete" value="<?php echo html_escape($gCat['id'], true) ?>"><i class="fa fa-times"></i></button>
                                            </td>
                                        </tr>
                                        <?php }
                                        } else{
