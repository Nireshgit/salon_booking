                                ...
                                <table class="table table-striped mt-3">
                                    ...
                                    <tbody>
                                        ...
                                        <?php $i = 1; foreach ($listGalleryWidCat as $listGall){ ?>
                                            <tr>
                                                <td><?php echo html_escape($i, true) ?></td>
                                                <td><img src="<?php uploads('gallery/'.$listGall['imgPath']) ?>" alt="" height="80px" width="80" class="mt-2 mb-2"></td>
                                                <td><?php echo html_escape($listGall['imgName'], true) ?></td>
                                                <td><?php echo html_escape($listGall['imgDetails'], true) ?></td>
                                                <td><?php echo html_escape($listGall['cName'], true) ?></td>
                                                <td class="text-right">
                                                    ...
                                                    <button type="button" class="btn btn-link btn-danger deleteImg" data-toggle="tooltip" data-placement="top" title="Delete" value="<?php echo html_escape($listGall['id'], true) ?>"><i class="fa fa-times"></i></button>
                                                </td>
                                            </tr>
                                        <?php $i++; } }?>
                                    </tbody>
