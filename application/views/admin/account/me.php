                                ...
                                <div class="col-md-12">
                                    <form method="POST" action="<?php anchor_to(ACCOUNT_CONTROLLER . '/me') ?>">
                                        <div class="form-group">
                                            ...
                                            <input id="admin-fullName" name="admin-fullName" placeholder="Enter your desired fullName" value="<?php echo html_escape($user['fullName']) ?>" type="text" class="form-control">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input id="admin-email" name="admin-email" placeholder="Enter your desired E-Mail" value="<?php echo html_escape($user['email']) ?>" type="email" class="form-control">
                                        </div>
                                        <div class="form-group">
