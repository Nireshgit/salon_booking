                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-right">
                                                ...
                                                <button type="button" class="btn btn-link btn-danger deleteclient" data-toggle="tooltip" data-placement="top" title="Delete" value="<?php echo html_escape($client['id'], true) ?>"><i class="fa fa-times"></i></button> 
                                            </td>
                                        </tr>
                                        <?php }
                                        } else{
