                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="text" name="client-name" value="<?php echo html_escape(set_value('client-name', $clients['fullName']), true)?>">
                                </div>
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="email" name="client-email" value="<?php echo html_escape(set_value('client-email', $clients['email']), true)?>">
                                </div>
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="text" name="client-phone" value="<?php echo html_escape(set_value('client-phone', $clients['phone']), true)?>">
                                </div>
