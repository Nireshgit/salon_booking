                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="text" id="contact-phone" name="contact-phone" placeholder="Type Phone Number with Country Code" value="<?php echo html_escape(set_value('contact-phone', $contactDetails['phone']), true)?>">
                                </div>
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="text" id="contact-email" name="contact-email" placeholder="Type Email" value="<?php echo html_escape(set_value('contact-email', $contactDetails['email']), true)?>">
                                </div>
                                <div class="form-group">
                                    ...
                                    <textarea id="service-content" name="contact-address" class="form-control"><?php echo html_escape(set_value('contact-address', $contactDetails['address']), true)?></textarea>
                                </div>
                                <div class="row">
                                    <div class="col-8">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" name="map_src" class="form-control" value="<?php echo html_escape(set_value('map_src', $contactDetails['map_src']), true)?>">
                                        </div>
                                    </div>
                                    <div class="col-2">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" name="map_wd" class="form-control" value="<?php echo html_escape(set_value('map_wd', $contactDetails['map_wd']), true)?>">
                                        </div>
                                    </div>
                                    <div class="col-2">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" name="map_ht" class="form-control" value="<?php echo html_escape(set_value('map_ht', $contactDetails['map_ht']), true)?>">
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" type="text" id="contact-urlFb" name="contact-urlFb" placeholder="Paste Facebook Url" value="<?php echo html_escape(set_value('contact-urlFb', $contactDetails['urlFb']), true)?>">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" type="text" id="contact-urlTwt" name="contact-urlTwt" placeholder="Paste Facebook Url" value="<?php echo html_escape(set_value('contact-urlTwt', $contactDetails['urlTwt']), true)?>">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" type="text" id="contact-urlIn" name="contact-urlIn" placeholder="Paste Facebook Url" value="<?php echo html_escape(set_value('contact-urlIn', $contactDetails['urlIn']), true)?>">
                                        </div>
                                    </div>
