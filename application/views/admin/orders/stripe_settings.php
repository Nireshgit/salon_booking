				  ...
				  <form action="<?php anchor_to(PAYMENTS_CONTROLLER . '/stripe') ?>" method="POST">
					<div class="card-body">
                        ...
                        <div class="form-group">
                           ...
                           <input type="text" name="stripe_currency" class="form-control resize-none" id="stripe_currency" placeholder="Enter your Stripe Currency." value="<?php echo html_escape($stripe['stripe_currency']) ?>">
								</div>
                        <div class="form-group">
