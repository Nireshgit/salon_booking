                                            ...
                                            <tbody>
                                                ...
                                                <?php foreach($page_data['recent_bookings'] as $i => $booking) {?>
                                                    <tr>
                                                        ...
                                                        <td><?php if($booking['agents_id']==0 ||$booking['agents_id']==''){echo 'Any Agent';}else{echo html_escape($booking['agentName'], true);} ?></td>
                                                        ...
                                                        <td><?php echo html_escape($booking['fullName'], true) ?></td>
                                                        ...
                                                        <td class="text-right">
                                                            <div class="dropdown">
                                                                ...
                                                                <div class="dropdown-menu dropdown-menu-right">
                                                                    ...
                                                                    <a href="<?php anchor_to(BOOKINGS_CONTROLLER . '/bookingPay/' . html_escape($booking['id'], true). '/true') ?>" class="btn btn-link btn-primary dropdown-item">Pay</a>
                                                                    <?php } ?>
                                                                    <?php if($booking['serviceStatus'] != '2' && !$booking['serviceStatus']) { ?>
                                                                    <a href="<?php anchor_to(BOOKINGS_CONTROLLER . '/bookingConfirm/' . html_escape($booking['id'], true). '/true') ?>" class="btn btn-link btn-primary dropdown-item">Confirm</a>
                                                                    <?php } ?>
                                                                    <?php if($booking['serviceStatus'] != '2' && !$booking['serviceStatus']) { ?>
                                                                    <a href="<?php anchor_to(BOOKINGS_CONTROLLER . '/bookingCancel/' . html_escape($booking['id'], true). '/true') ?>" class="btn btn-link btn-primary dropdown-item">Cancel</a>
                                                                    <?php } ?>
                                                                    <a href="<?php anchor_to(BOOKINGS_CONTROLLER . '/deleteBookings/' . html_escape($booking['id'], true). '/true') ?>" class="btn btn-link btn-danger dropdown-item">Delete</a>
                                                                </div>
                                                            </div>   
                                                        </td>
                                                    </tr>
                                        ...
                                        <table class="table table-striped mt-3">
                                            ...
                                            <tbody>
                                                ...
                                                <?php foreach($page_data['clients'] as $i => $client) { ?>
                                                    <tr>
                                                        <td><?php echo html_escape($client['fullName'], true) ?></td>
                                                        <td><?php echo html_escape($client['email'], true) ?></td>
                                                        <td><?php echo html_escape($client['phone'], true) ?></td>
                                                        <td class="text-right">
