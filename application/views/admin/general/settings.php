						...
						<div class="row">
							<div class="col-lg-6">
								<div class="form-group">
									...
									<input type="text" name="site-title" class="form-control form-control-lg py-3 px-5" id="title" value="<?php echo html_escape(set_value('site-title', $page_data['general']['title']), true)?>" placeholder="Choose your Website's title">
								...
								<div class="form-group">
									...
									<textarea rows="4" name="site-description" class="form-control resize-none" id="service-content" placeholder="Enter the Website Description"><?php echo html_escape(set_value('site-description', $page_data['general']['description']), true)?></textarea>
								...
								<div class="form-group">
									...
									<input type="text" name="site-keywords" value="<?php echo html_escape(set_value('site-keywords', $page_data['general']['keywords']), true)?>" class="form-control form-control-lg resize-none" id="keywords" placeholder="Enter the Website Keywords">
								</div>
							</div>
							<div class="col-lg-6">
								<div class="row">
