                                    ...
                                    <div class="row">
                                        <?php foreach($themes as $theme) { ?>
                                            <!--<a href="<?php anchor_to('general/set_theme/' . $theme['manifest']['identifier']) ?>">
                                                <img src="<?php echo html_escape($theme['thumbnail']) ?>">
                                            </a>-->
                                            <div class="col-lg-4 col-md-6">
                                                <div class="card">
                                                    <div class="card-header">
                                                    <div><?php echo html_escape($theme['manifest']['name']); if($current_theme == $theme['manifest']['identifier']) { ?><span class="badge badge-secondary float-right">Currently in Use.</span><?php } ?></div>
                                                    </div>
                                                    <div class="card-body">
                                                        <img class="rounded img-fluid" src="<?php echo html_escape($theme['cover']) ?>">
                                                    </div>
                                                    <div class="card-footer">
                                                        <span class="badge badge-danger">By: <?php echo html_escape($theme['manifest']['author']['name']); ?></span>
